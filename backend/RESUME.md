...
![Employees Collection Types](./static/img/employees-collection-types.png)

Then, navigate to `Resumes` and click **Add new Resumes** to create your new resume.

![Resumes Collection Types](./static/img/resumes-collection-types.png)
...
![Resumes Layout](./static/img/resume-layout.png)
...
![Selecting Employee](./static/img/selecting-employee.png)
