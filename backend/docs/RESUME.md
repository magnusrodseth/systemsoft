...
![Employees Collection Types](../static/img/resume/employees-collection-types.png)

Then, navigate to `Resumes` and click **Add new Resumes** to create your new resume.

![Resumes Collection Types](../static/img/resume/resumes-collection-types.png)
...
![Resumes Layout](../static/img/resume/resume-layout.png)
...
![Selecting Employee](../static/img/resume/selecting-employee.png)
