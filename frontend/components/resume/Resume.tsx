...
const Resume: React.FC<ResumeProps> = ({ resume }) => {
  return (
    <div className="min-height-container bg-gradient-to-b from-blue-100 to-[#050552]">
      <div className="min-height-container flex justify-center flex-col space-y-8">
        ...
        {resume.Organisation ? (
          <Organization
            organizations={resume.Organisation as IOrganization[]}
          />
        ) : null}
        ...
        {resume.ResumeReference ? (
          <ResumeReference
            references={resume.ResumeReference as IReference[]}
          />
        ) : null}
      </div>
    </div>
